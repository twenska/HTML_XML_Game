    ...
    create ()
        {
            ...
            paper.create(580,435,'Paper').setAngle(180);
            paper.create(595,435,'Paper').setAngle(180);
            paper.create(590,439,'Paper').setAngle(180);
            paper.create(590,425,'Paper').setAngle(180);
        ...
        this.DialogPhishing_Opt1.add(this.add.text(240,430,"[Kurz nach dem du das Update\ninstalliert hast, meldet sich die Antiviren-\nsoftware des PC.]",{font:"18px Courier"}).setColor("black"));
        this.DialogPhishing_Opt1.add(this.add.text(240,430,"Oh je, was ist das?\nDu scheinst einen Virus installiert zu haben...",{font:"18px Courier"}).setColor("black"));
        this.DialogPhishing_Opt1.add(this.add.text(240,430,"Jetzt werde ich der IT doch\nBescheid geben müssen...\nIch dachte du kennst dich mit sowas aus?!",{font:"18px Courier"}).setColor("black"));
        this.DialogPhishing_Opt1.add(this.add.text(240,430,"Vielleicht machst du jetzt etwas\neinfacheres... Der Besucherbereich\nwurde unordentlich hinterlassen.",{font:"18px Courier"}).setColor("black"));
        this.DialogPhishing_Opt1.add(this.add.text(240,430,"Geh bitte und\nräume ihn auf!",{font:"18px Courier"}).setColor("black"));
        this.DialogPhishing_Opt1.toggleVisible();

        this.DialogPhishing_Opt2.add(this.add.text(240,430,"Gut, dass ich dich gefragt habe!\nIch hätte das Update installiert...",{font:"18px Courier"}).setColor("black"));
        this.DialogPhishing_Opt2.add(this.add.text(240,430,"In Zukunft werde ich mehr aufpassen müssen.\nKönntest du als nächstes in\nden Wartebereich gehen und dort etwas\naufräumen?",{font:"18px Courier"}).setColor("black"));
